...
UPDATE pago SET fechaLimite=(CURRENT_DATE() + INTERVAL 3 DAY) WHERE idSolicitud IN(4);
UPDATE pago SET fechaLimite=(CURRENT_DATE() + INTERVAL 1 DAY) WHERE idSolicitud IN(10);
